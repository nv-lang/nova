...
1. /install/ — АКТУАЛИЗИРОВАНА 2026-08-02 (исполнено сессией сайта: --recursive, релиз-нейтральность; остаток чистой установки — gc.lib, закрывается окном №268+№269 в nova).
