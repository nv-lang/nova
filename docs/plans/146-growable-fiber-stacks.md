...
### 6.1 Cheap-first (вместо растущих стеков) → **[Plan 149](149-configurable-fiber-arena.md)**
...
округление вверх + clamp)** → 2× плотность + любой потолок по запросу. **Оформлено как Plan 149**
