...
> **Уровень:** Top-level.
> **Создан:** 2026-06-26. **Статус:** `📋 READY` (**Ред. 2 — 2026-07-03**: аудит ground-truth/7-языков; M-161-фактчек CLOSED, seam → auto_derive.rs, None→null, layering-fix VariantPayload, Zig-колонка, Q22 Timestamp, spec_tests d340–d346).
