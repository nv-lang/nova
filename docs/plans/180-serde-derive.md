...
> **Уровень:** Top-level.
> **Создан:** 2026-06-26. **Статус:** `📋 READY` → **Ф.0-VERIFY выполнен 2026-07-04 (эмпирика — см. §0)**; Ф.1–Ф.4 GATED на 2 codegen-фикса + f64-formatter (см. §0). (**Ред. 2 — 2026-07-03**: аудит ground-truth/7-языков; M-161-фактчек CLOSED, seam → auto_derive.rs, None→null, layering-fix VariantPayload, Zig-колонка, Q22 Timestamp, spec_tests d340–d346).
