...
> ([169.1.2](169.1.2-consolidate-tests.md)/[169.1.3](169.1.2-consolidate-tests.md)).
...
Консолидация ([169.1.2](169.1.2-consolidate-tests.md)/
[169.1.3](169.1.2-consolidate-tests.md)): конфликтующие helper'ы помечать
