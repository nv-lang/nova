...
| 14 | [14-stdlib-codegen-gaps.md](14-stdlib-codegen-gaps.md) | Закрыть codegen-gap'ы блокирующие std/* (Iter[T] element-type, const non-trivial, free-fn-as-value, fn-в-record, D69 variadic, cross-file resolve, `int as char` literal) | частично (Ф.2 const non-trivial ✅, Ф.3 free-fn-as-value ✅, Ф.4 fn-в-record ✅; остаются Ф.1/Ф.5/Ф.6/Ф.7) |
