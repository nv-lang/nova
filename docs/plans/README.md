...
| http | [178](178-std-http.md) (umbrella) + [222](222-http-framework.md) (зонтик: nova-http как веб-фреймворк — Router/extractors/middleware/run-loop hardening; волна A в работе) |
