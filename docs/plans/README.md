...
| http | [178](178-std-http.md) (umbrella) + [222](222-http-axum-parity.md) (зонтик: nova-http до Axum-паритета — Router/extractors/middleware/run-loop hardening; волна A в работе) |
| encoding/compress | [179](179-std-encoding-compress.md) |
| serde / typed-json | [180](180-serde-derive.md) + [222.2](222-http-axum-parity.md) (field-атрибуты до Rust-паритета) |
