...
| 14 | [14-stdlib-codegen-gaps.md](14-stdlib-codegen-gaps.md) | Закрыть codegen-gap'ы блокирующие std/* (Iter[T] element-type, const non-trivial, free-fn-as-value, fn-в-record, D69 variadic, cross-file resolve, `int as char` literal) | ⏸️ **PAUSED** (Ф.1/2/3/4/7 ✅; Ф.6 ⚠️ codegen-only — interp variadic Ф.6-bis pending; Ф.5 + std blockers — позже) |
