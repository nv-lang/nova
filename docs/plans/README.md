...
| 14 | [14-stdlib-codegen-gaps.md](14-stdlib-codegen-gaps.md) | Закрыть codegen-gap'ы блокирующие std/* (Iter[T] element-type, const non-trivial, free-fn-as-value, fn-в-record, D69 variadic, cross-file resolve, `int as char` literal) | частично (Ф.1 ✅ Option[T] full refactor, Ф.2 ✅, Ф.3 ✅, Ф.4 ✅, Ф.7 ✅; остаются Ф.5/Ф.6) |
