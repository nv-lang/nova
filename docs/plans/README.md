...
| 12 | [12-builtins-driven-codegen.md](12-builtins-driven-codegen.md) | builtins.nv-driven external dispatch + auto-derive try_*/into() из Fail-form/from() (Q-codegen-builtins-cleanup) | pending, готов к старту |
