...
| 14 | [14-stdlib-codegen-gaps.md](14-stdlib-codegen-gaps.md) | Закрыть codegen-gap'ы блокирующие std/* (Iter[T] element-type, const non-trivial, free-fn-as-value, fn-в-record, D69 variadic, cross-file resolve, `int as char` literal) | почти полностью (Ф.1/Ф.2/Ф.3/Ф.4/Ф.6/Ф.7 ✅; остаётся только Ф.5 cross-file) |
