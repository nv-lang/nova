...
[docs/dev/research/](../dev/research/). Рабочие файлы живых волн (чекпоинты/progress/notes/карты/
...
(`bash scripts/tools/gen-plan-status.sh`; git-копия протухает между перегенерациями —
...
| Модуль | План |
|---|---|
| parse (str→примитив) | [174.1](174.1-primitive-parse-api.md) + [282](282-numeric-conversions.md) (грамматика и целые) + [283](283-float-parse-own-rounding.md) + [283.1](283.1-float-parse-own-module.md) (тот же порт отдельным модулем `runtime.float_parse`) (float без libc: своё верное округление, пара к 285) |
...
- [docs/dev/research/](../dev/research/) — справочные материалы и сравнения.
