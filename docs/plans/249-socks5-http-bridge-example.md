...
`examples/flagship/socks5_http_bridge/README.md`.**
...
- **Ф.2 — 🚧 КОД НАПИСАН, НЕ ПОДКЛЮЧЁН (окно p249-socks-bridge, 2026-08-08).**
  ...
  в `examples/flagship/socks5_http_bridge/main.nv` (НЕ в
  ...
  `examples/flagship/socks5_http_bridge/README.md`. **Механизм терминации
