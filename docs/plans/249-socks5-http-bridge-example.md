...
**РАЗБЛОКИРОВАН 2026-08-08: №390 ЗАКРЫТ — Ф.2 (мост) можно начинать.** Корень зависания оказался НЕ сетевым: escape-анализ не промоутил  в кучу,  был висячим указателем на стек, refcount TcpStream портился,  не вызывался — сервер физически НЕ ЗАКРЫВАЛ сокет (реестр №390, коммит b55f8cc1d; класс — №450). Прежняя запись «Ф.2 открывается после тега» УСТАРЕЛА: блокера больше нет. Пакет  опубликован на три зеркала. Остаётся написать сам мост (Ф.2) и plain-HTTP путь (Ф.3); требование обязательного  на каждом чтении СОХРАНЯЕТСЯ как общая норма против зависаний, но уже НЕ как обход №390.
