...
> **Полный план вынесен в отдельный файл → [179.1-civil-time.md](179.1-civil-time.md)** (создан 2026-06-22).
> Ниже — краткий эскиз для контекста; источник истины по civil-time — файл 179.1.
>
> **Статус:** proposal. Самостоятельный под-план поверх типизированного фундамента 179.
