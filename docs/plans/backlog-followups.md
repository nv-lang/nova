...
| `[M-fiber-arena-raise-cap]` | ✅ **ОФОРМЛЕНО как [Plan 148](148-configurable-fiber-arena.md)** (2026-06-12) — configurable fiber arena: стек/макс через env (`NOVA_FIBER_STACK`/`NOVA_MAX_FIBERS`) + nova.toml `[runtime]`, default 4MB, авто-округление вверх + clamp. Дальнейшая работа — в Plan 148 (PLANNED). | Plan 148 | → Plan 148 |
