...
## [M-tls-xpkg-decode_utf8-tlsversion-dispatch-broken] — cross-package sum-type/extension-method dispatch даёт битый C для nova-tls (P1, 2026-07-15, найдено при верификации vendor-ffi build-фикса)
