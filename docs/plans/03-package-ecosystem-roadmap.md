...
| **03.3** | [03.3-registry-protocol.md](03.3-registry-protocol.md) | HTTP registry protocol + content-addressing + подпись + transparency log (§5). Задел из 03.1/03.2/03.4 зафиксирован. | 03.2 | 📋 proposed, отложен (нужна инфраструктура) |
