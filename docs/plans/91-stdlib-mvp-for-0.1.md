...
| 91.8b | [Operator dispatch через protocols (D184)](91.8b-operator-dispatch-protocols.md) | `==`→`@equal`, `<`/`>`/`<=`/`>=`→`@compare`; удалить `@eq/@lt/@le/@gt/@ge` magic methods | 🔴 OPEN (зависит от 91.8a) |
| 91.8c | [Generic array API: sort/min/max + _by (D185)](91.8c-generic-array-api.md) | `fn[T Compare]` sort/binary_search/min/max + callback `_by` variants | 🔴 OPEN (зависит от 91.8a) |
