...
- [x] 8 realistic conformance fixtures `nova_tests/plan91_fe4/` — **8/0 PASS** (release nova, codegen-канал)
- [x] `time`: duration_budget_pipeline (19 asserts), timestamp_deadline_and_elapsed (14), duration_signed_and_scale (18)
- [x] `math`: geometry_distance_and_angle (8), trig_unit_circle (10), rounding_and_special_values, logarithm_and_exponential
- [x] `sort`: sort_aggregate_pipeline (16 — sort/sort_by/binary_search/min/max/sum/product)
