...
| 173    | B | 🔨 | **Ф.1 ЗАКРЫТА** (#1 25e07590 · #2 4a02c825 · #4 84e6e709 · #3 `?`-return-only ea55bee7 · #7 parfor-guard 7514b262); далее Ф.2 defer-kernel (D314 spec-first) ИЛИ Track A 172.12/172.13 |
| 174    | B | ⏳ | после 173 |
| 176    | B | ⏳ | после 173 |
| 175    | B | ⏳ | параллельно |
