...
| 173    | B | 🔨 | **Ф.1 ЗАКРЫТА** (#1/#2/#4/#3/#7). **Ф.2 defer-kernel В РАБОТЕ:** Ф.2.0 D314-spec + де-риск-карта закрыты (c625808e; 🔴 D194-премиса ложна→parity+followup, nova_scope_exit policy, rename-collision, interrupt→Failure). Реализация: ✅A0→✅R1(43f9ee5b)→✅R2(ffb76506)→✅B1 parser/AST defer(o)(e0d95a31; +доукомплектовал #3 e3fce6f3)→**B2 codegen outcome-материализация(next)**→B3 consume-desugar→C nova_scope_exit→D194→E-hub |
| 174    | B | ⏳ | после 173 |
| 176    | B | ⏳ | после 173 |
| 175    | B | ⏳ | параллельно |
