...
**D-блоки:** D301
**Зависит от:** Plan 91.12 ✅ (std/net V2 algebraic effects, TcpStream), Plan 166 ✅ (UDP split D377, ex-D298 — образец)
...
// NB: эффект `Blocking` отозван (Plan 91.15 P0) — операции несут только `TcpNet`.
