...
> **Автосгенерировано**: `bash scripts/tools/gen-plan-status.sh`, дата генерации: 2026-08-28 22:23 UTC.
...
| [276](276-agent-process-borrowings.md) | План 276. Приёмы работы с агентом — восемь заимствований | 📋 ПРИНЯТ 2026-08-26 (номер присвоен интегратором; черновик окна 274 |
