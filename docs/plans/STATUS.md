...
| [174.6](174.6-ffi-abi-types.md) | Plan 174.6 — C-FFI ABI: типы extern "C" + ABI fn-указателей (спека догоняет реальность) | 🚧 M0 (spec) ✅ DONE 2026-07-04; **M1 (parser `*extern "C" fn` + checker `E_FFI_NON_C_ABI_TYPE` + коэрция-гейт + error-index + dedup-hardening) ✅ DONE 2026-07-04**; **M2/M3-additive (cast-матрица D353 + conformance `d282_ffi_abi` pos+9 neg + ffi-cookbook C-ABI-раздел + `*extern "C" fn` в n… |
