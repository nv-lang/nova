...
> **Автосгенерировано**: `bash scripts/tools/gen-plan-status.sh`, дата генерации: 2026-09-02 20:01 UTC.
...
| [280](280-caller-loc.md) | План 280 — Место вызова, доступное коду: CallerLoc + caller_loc() | 🚧 ПРИНЯТ, НЕ НАЧАТ — механизма нет ни строкой, написаны только спека и план. |
