...
> **Автосгенерировано**: `bash scripts/tools/gen-plan-status.sh`, дата генерации: 2026-09-15 22:24 UTC.
...
| [172.15](172.15-value-placement-abi-audit.md) | План 172.15 — Размещение значений и ABI: механизмы есть, границы не описаны | 🚧 Ф.0 и Ф.1 ЗАКРЫТЫ 2026-08-08 (инвентарь прогоном, отчёт [wip/RECON-value-placement-abi.md](wip/RECON-value-placement-abi.md), окно `p253-abi-inventory`); Ф.1-Ф.4 не начаты. Продолжение семейства 172 — |
...
| [173.4](173.4-failure-report-contract.md) | План 173.4 — Запись отказа: контракт вывода и доступ из кода | 🔨 В РАБОТЕ (заведён 2026-08-16 по вопросу владельца «в рамках какого |
...
| [221](221-release-v0-1.md) | План 221 — Release v0.1 (первая прод-версия Nova) | ❌ ЗАКРЫТ 2026-09-16 КАК НЕЗАВЕРШЁННЫЙ — тега v0.1 оракула не |
...
| [221.2](221.2-luck-audit.md) | 221.2 — Каталог «мест на удаче» (аудит-волна 2026-08-02) | ✅ ЗАКРЫТ 2026-09-16 как ВЫПОЛНЕННЫЙ КАТАЛОГ — вместе с планом 221 |
| [221.3](221.3-oracle-blocks-carina.md) | 221.3 — СВЕДЁН в 274.10 | ✅ СВЕДЁН 2026-09-16 в [274.10](274.10-oracle-tax-on-carina.md) — |
...
| [234](234-bitwise-operator-family.md) | План 234 — побитовое семейство: bit-префикс + оператор ~ | ✅ СДЕЛАНО — подтверждено ЗАМЕРОМ 2026-08-27 (интегратор). |
| [235](235-bigint.md) | План 235 — std.math.bigint: целые произвольной точности на чистом Nova | ✅ **V1 РЕАЛИЗОВАН 2026-07-30** — репа `nova-bignum` (`master`, github, коммит `35bc047`). |
| [236](236-bigdecimal.md) | План 236 — bigdecimal (пакет nova-bignum): десятичная произвольной точности поверх BigInt | ✅ ЗАКРЫТ 2026-07-31 — V1 сдан (окно sonnet, приёмка интегратора: check 5/0, test 4/0/1, запушено на 3 ремоута). Три пина Ф.0 проверены фактом; 3 дефекта компилятора заведены (№170-№172), порядок атрибу… |
| [237](237-bigfloat.md) | План 237 — bigfloat (пакет nova-bignum): двоичная произвольной точности поверх BigInt | ЗАКРЫТ (2026-08-01) — BigFloat V1 влит в nova-bignum master (1ef06b1): mantissa/exp, нормализация, конверсии f64 (включая субнормали), sqrt; тесты 5/0, strict-effects 7/0. Попутный компилятор-дефект — [M-option-int-cast-u64-cc-fail] в р… |
| [238](238-fiber-memory-model.md) | План 238 — модель памяти между файберами: энфорс №150 + спек-амендмент | 🔨 ПЕРЕОТКРЫТ 2026-08-04 (см. §«Продолжение» в конце). Исходная часть — ✅ ИСПОЛНЕНА И ВЛИТА 2026-07-31 (окно p238-fiber-memory, sonnet; приёмка интегратора). |
...
| [240](240-bigrat.md) | План 240 — bigrat (пакет nova-bignum): точные рациональные числа поверх BigInt | ✅ ЗАКРЫТ 2026-08-02 — Ф.1–Ф.6 влиты в nova-bignum main (e5ef51f): gcd, ядро BigRat, арифметика, строки/мосты, тесты+эталоны (slow-lane), README; приёмка интегратора: test 9/0 SKIP4, check 13/0/38 --strict-effects, lint 0 (9 находок поч… |
| [241](241-spec-bilingual.md) | План 241 — двуязычная дока ВЕЗДЕ: spec en-переводы + guide ru-пары + двуязычный сайт | 🆕 PLANNED-DETAILED (детализирован 2026-08-03 по слову владельца «два языка |
...
| [243](243-bigint-family-complete.md) | План 243 — bigint-семья: добор ВСЕХ отложенных пунктов (слово владельца: «не надо откладывать на V2») | 🆕 PLANNED-DETAILED (записан 2026-08-03; директива владельца — семья |
| [244](244-channel-in-nova.md) | План 244 — Channel НА NOVA (не обёртка над C), снос ad-hoc веток кодогенератора | ✅ УТВЕРЖДЁН ВЛАДЕЛЬЦЕМ 2026-08-03 («244 — ок»). К исполнению. |
| [245](245-ffi-typed-handles.md) | План 245 — Типизированные ручки на границе FFI (миграция std) | 🆕 ЗАПЛАНИРОВАН 2026-08-02. Дефект — [№288](221.1-bug-sweep.md). |
| [246](246-linear-containers.md) | План 246 — Линейные контейнеры (Vec[T consume]): владение внутри коллекций | 🔬 ИССЛЕДОВАНИЕ + ПРОЕКТ. Заказ владельца 2026-08-03: |
| [247](247-guide-english-side.md) | План 247 — настоящий английский на английской стороне guide | ✅ ЗАКРЫТ (2026-08-04). Английская сторона всех гайдов написана по-английски (батчи 1-2 + дочистка), русские комментарии в примерах переведены синхронно в обеих сторонах, метки фаз за… |
| [248](248-shared-handles-linearity.md) | План 248 — Разделяемые ручки: линейность вместо честного слова | 🆕 ЗАПЛАНИРОВАН 2026-08-04 (заказ владельца: «выглядит так, что `AtomicInt` |
| [249](249-socks5-http-bridge-example.md) | План 249 — пакет nova-socks + пример examples/flagship/http_proxy_chain/ | 🚧 ЧАСТИЧНО ИСПОЛНЕН. Ф.П/Ф.1/Ф.4 ГОТОВЫ (пакет `nova-socks` |
| [250](250-vela-state-consolidation.md) | План 250 — Vela: консолидация состояния фибра к одному авторитетному слову | 🚧 ПРОЕКТИРОВАНИЕ ИДЁТ. Ф.0 (инвентарь) и Ф.1 (проект слова) — |
| [251](251-runtime-termination-audit.md) | План 251 — Аудит завершения процесса: 291 точки abort() в рантайме | 🆕 ЗАПЛАНИРОВАН 2026-08-07 по мандату владельца «нам нужны итоговые |
| [251.1](251.1-abort-inventory.md) | План 251.1 — инвентарь точек abort() (результат Ф.0 плана 251) в рантайме (сырое перечисление) | 📋 СЫРОЙ ИНВЕНТАРЬ (Ф.0 плана 251), составлен 2026-08-08 автоматическим перечислением (opencode). Только факты из кода: место, функция, печатаемое сообщение, условие, соседние вызовы. **Кла… |
| [252](252-std-analysis-cache.md) | План 252 — Кэш анализа std: перестать разбирать корпус заново на каждый файл | 🔴 ПЕРВООЧЕРЕДНОЙ 2026-08-09 — приоритет поднят замером плана |
| [253](253-invariant-reduction-umbrella.md) | План 253 — Сокращение инвариантов и «дверей»: зонтик | 🆕 ЗАПЛАНИРОВАН 2026-08-08, ЗОНТИК (по образцу плана |
| [253.1](253.1-receiver-mode.md) | План 253.1 — Режимы получателя/параметра/поля: ReceiverMode вместо пары mutable/consume | 🆕 ЗАПЛАНИРОВАН 2026-08-08, готов к исполнению (разведка p-inv-compiler |
| [253.2](253.2-contract-doors.md) | План 253.2 — Двери контрактов: инвариант записи проверяется в одной точке из многих | 🚧 ЧАСТИЧНО ИСПОЛНЕН 2026-08-08 — Ф.1 ЗАКРЫТА (до тега, по решению владельца «исправить до тега»); Ф.0/Ф.2/Ф.3/Ф.4 не начаты. Подплан зонтика |
| [253.4](253.4-disarm-registry.md) | План 253.4 — Реестр дизарма: кодоген заново решает задачу резолва по именам | 🚧 Ф.0 и Ф.1 ИСПОЛНЕНЫ 2026-08-08 в ветке `p253-disarm` (окно |
| [254](254-process-rules-without-mechanism.md) | План 254 — Правила процесса без механизма: 57 из 74 держатся на памяти | 🆕 ЗАПЛАНИРОВАН 2026-08-08. Самостоятельный план. Основание — |
| [255](255-compile-pipeline-profiling.md) | План 255 — Профиль этапов компиляции: где на самом деле уходят 40 минут | 🆕 ЗАПЛАНИРОВАН 2026-08-09. Дефект-корень — [№481](221.1-bug-sweep.md). |
| [256](256-gc-pause-budget.md) | План 256 — Паузы сборщика: доказать фикс и завести бюджет | 🆕 ЗАПЛАНИРОВАН 2026-08-09. Дефект-корень — [№474](221.1-bug-sweep.md) |
| [257](257-spec-form-enforcement.md) | План 257 — Правила формы записи: норма есть, энфорса нет | 🆕 ЗАПЛАНИРОВАН 2026-08-09. Дефекты-корни — |
| [258](258-std-net-ownership.md) | План 258 — std.net: один источник истины о владении | 🆕 ЗАПЛАНИРОВАН 2026-08-09. Основание — сплошной аудит модуля (окно |
| [259](259-fiber-arena-guard-pages.md) | План 259 — guard-страницы файбер-арены: почему они не масштабируются и чем их заменить | 🆕 ЗАПЛАНИРОВАН 2026-08-09. Основание — установленная окном `p457-timeout` |
| [260](260-gate-speed-optimizations.md) | План 260 — ускорение авторитетного гейта: что измерено, что найдено, что делать | 🟡 В РАБОТЕ 2026-08-09. Первая мера уже в main. |
| [261](261-package-repos-under-gate.md) | План 261 — пакетные репозитории под авторитетным гейтом | 🆕 ЗАПЛАНИРОВАН 2026-08-09. Основание — требование владельца |
| [262](262-lsp-parity-and-expected-errors.md) | План 262 — LSP не расходится с компилятором; ожидаемая ошибка помечается на месте | 🆕 ЗАПЛАНИРОВАН 2026-08-09. Основание — [№531](221.1-bug-sweep.md) |
| [263](263-registry-plan-linkage.md) | План 263 — запись реестра называет план, которым чинится | 🆕 ЗАПЛАНИРОВАН 2026-08-10 по решению владельца. |
| [264](264-separator-rule.md) | План 264 — правило разделителей (D452): привести язык к решению | 🟡 В РАБОТЕ 2026-08-10. Решение владельца принято, [D452](../../spec/decisions/03-syntax.md#d452) |
| [265](265-stdlib-surface-gaps.md) | План 265 — поверхность std: чего не хватает языку и в каком порядке чинить | 🆕 ЗАПЛАНИРОВАН 2026-08-10. Основание — аудит экспортной поверхности |
| [266](266-cancellation-outcome.md) | План 266 — исход отмены выражен значением области (D455) | 🆕 ЗАПЛАНИРОВАН 2026-08-10 по решению владельца (вариант «C» из |
| [267](267-module-root-naming.md) | План 267 — виртуальный корень модулей: src/ сбрасывает имя пакета (D78 rev-6) | 🆕 ЗАПЛАНИРОВАН 2026-08-10. Основание — решение владельца того же дня |
| [268](268-effect-boundary-reform.md) | План 268 — граница эффекта: убрать таблицу системных вызовов из Os, Fs, Net (D456) | 🆕 ЗАПЛАНИРОВАН 2026-08-11. Основание — решение владельца того же дня; |
| [269](269-package-visibility.md) | План 269 — видимость уровня пакета: priv(package) (D457) | 🆕 ЗАПЛАНИРОВАН 2026-08-11. Основание — решение владельца того же дня; |
| [270](270-builtin-name-vs-declaration.md) | План 270 — имя против объявления: пользовательский метод на встроенном имени (№576) | 🆕 ЗАПЛАНИРОВАН 2026-08-11. Основание — воспроизведённый дефект |
| [271](271-display-one-mechanism.md) | План 271 — печать значений: один механизм и один буфер (ПРЕДВАРИТЕЛЬНЫЙ) | 📝 **ПРЕДВАРИТЕЛЬНЫЙ — РЕШЕНИЕ НЕ ПРИНЯТО.** Владелец 2026-08-11: |
| [272](272-effect-method-form.md) | План 272 — метод-форма операции эффекта | 🟠 РАЗДВОЕН ПО АДРЕСАТАМ решением владельца 2026-09-13 — |
| [273](273-one-form-for-methods-and-functions.md) | План 273 — одна форма для методов и функций | ЧЕРНОВИК. Идея владельца 2026-08-12; разбор интегратора в тот же |
| [274](274-novac-self-hosted-compiler.md) | План 274 — novac: компилятор Nova на Nova (зонтичный) | 🚧 В РАБОТЕ с 2026-08-14 (день 1 месяца §1.4); Э0 закрыт, ядро Э1 взято, идёт Э2 (Э2-а 5/6, Э2-б1 закрыт 2026-08-16, Э2-б2 закрыт, **Э2-б3 закрыт 2026-08-23 — подплан §9.1е пройден целиком, волны В1–В5**; идёт р… |
| [274.1](274.1-novac-architecture.md) | План 274.1 — архитектура novac: собрать из референсов | 🆕 ЗАПЛАНИРОВАН 2026-08-14. Первый ребёнок зонтика. |
| [274.2](274.2-novac-iteration-cost.md) | План 274.2 — цена итерации novac: секунды, не минуты | 🔨 В РАБОТЕ с 2026-08-15 (заведён по слову владельца: «срочно оптимизируй время |
| [274.3](274.3-review-findings-classes.md) | План 274.3 — находки ревью novac: классы по корню, фикс класса, защита от класса | 🔨 В РАБОТЕ с 2026-08-15 (заведён по слову владельца: «запиши в план все пункты |
| [274.4](274.4-one-door-per-root.md) | 274.4 — Одна дверь на корень: разрез подбора, приватность индекса, владелец корня | 🚧 В РАБОТЕ с 2026-08-28 (подплан [274](274-novac-self-hosted-compiler.md), |
| [274.5](274.5-read-own-source.md) | Подплан 274.5 — читать свой исходник: шесть форм, названных замером | 🚧 В РАБОТЕ с 2026-08-29. Родитель — [274](274-novac-self-hosted-compiler.md) |
| [274.6](274.6-fix-tuple-to-record-door.md) | 274.6 — Кортеж есть запись на стеке: свести бухгалтерию к одной | 🚧 В РАБОТЕ с 2026-09-03 (подплан [274](274-novac-self-hosted-compiler.md), |
| [274.7](274.7-subset-to-spec.md) | План 274.7 — снятие подмножества: спека на 100%, без упрощений | 🔨 В РАБОТЕ (заведён 2026-09-05 по решению владельца — 274 §1.3а). **СДЕЛАНО:** В1а (интерполяция — все примитивные семьи, 2026-09-05). **ОСТАЛОСЬ:** В1б, В1в, порядок дальнейших волн по замеру ча… |
| [274.8](274.8-novac-mir.md) | План 274.8 — MIR для Карины: одно понижение вместо шести дверей | 🚧 В РАБОТЕ — слито M0, M2b-1а и шаги 0/1/2/3а M2b-2; (3а) закрыта обеими половинами критерия (C побайтово + обратные пробы 2026-09-08). **M2c закрыт критерием 2026-09-09** (дифф C пуст после нормализаци… |
| [274.9](274.9-carina-linearity-consume.md) | План 274.9 — линейность и consume в Карине: перечень, волны, приёмка | 🆕 ЗАПЛАНИРОВАН 2026-09-11 по слову владельца: «consume — там не всё так |
| [274.10](274.10-oracle-tax-on-carina.md) | План 274.10 — чего Карине стоит оракул: ломает сегодня · платит обходом · сломает при правильной | ОТКРЫТ 2026-09-16. **Ведёт:** интегратор. |
| [274.11](274.11-carina-release.md) | План 274.11 — релиз Карины: что должно быть сделано до её тега | ОТКРЫТ 2026-09-16, ни один пункт не начат. |
| [275](275-gate-cost.md) | План 275. Цена гейта: привести стражей к Г-правилам конвенции | 🟡 В РАБОТЕ (заведён 2026-08-21 интегратором по решению владельца). |
| [276](276-agent-process-borrowings.md) | План 276. Приёмы работы с агентом — восемь заимствований | ✅ ВСЕ ВОСЕМЬ ШАГОВ ЗАКРЫТЫ 2026-08-29 (по каждому — вердикт на каждый критерий; там, где приёмка глазами и её никто ещё не сделал, так и написано «не запускалась», а не «выполнено»). … |
| [277](277-string-literals.md) | План 277. Строковые литералы: продолжение строки, голый backtick, гигиена тела | 🛠️ В РАБОТЕ — ПЯТЬ ИЗ ШЕСТИ ФАЗ ЗАКРЫТЫ 2026-08-30 (Ф.0 спека, Ф.1 |
| [278](278-defect-hunter-agent.md) | План 278. Агент-охотник за дефектами | ✅ СДЕЛАН 2026-08-30 — все СЕМЬ фаз закрыты. Сегодня же принят и РЕАЛИЗОВАН регламент владельца (Ф.5 долг-триггер, Ф.6 треки и свёртка — четыре стража в гейте, 32 подделки в самотестах)… |
| [279](279-mn-safety-via-effects.md) | План 279 — Безопасность M:N через эффекты | ⬛ ЧЕРНОВИК (номер назначен интегратором 2026-09-02; к исполнению не принят) |
| [280](280-caller-loc.md) | План 280 — Место вызова, доступное коду: CallerLoc + caller_loc() | 🛠️ МЕХАНИЗМ ГОТОВ — Э1, Э2, Э3, Э3-б, Э5 и база Э7 закрыты 2026-09-03, Э4 ОТОЗВАН владельцем; реестр №683 ЗАКРЫТ. Осталась страница гайда и Э6 (носитель, трек 274). |
| [281](281-typed-index-vec.md) | План 281 — типизированный индекс: IndexVec[I Ordinal, T] и шесть дефектов под ним | Ф.1 ЗАКРЫТА 2026-09-05 — единственная фаза, шедшая как блокер тега (того самого, что снят четырьмя днями позже), сдана ОБЕИМИ половинами, строки №894 и №628 закрыты по замеру (блокеров … |
| [282](282-numeric-conversions.md) | План 282 — числовые конверсии: один словарь, одна дверь на пару, грамматика чисел наша | Ф.0–Ф.4 ЗАКРЫТЫ 2026-09-05 (спека прежде реализации, std следом, тесты зелёные — |
| [283](283-float-parse-own-rounding.md) | План 283 — своё округление float: порт core::num::dec2flt из Rust | ЗАКРЫТ 2026-09-07 — Ф.0-Ф.7 приняты компилятором; единственный незакрытый |
| [283.1](283.1-float-parse-own-module.md) | План 283.1 — разбор float отдельным модулем runtime.float_parse | ВОЛНА ЗАКРЫТА 2026-09-07 (слот 15:49–15:57): Ф.0, Ф.1+Ф.2 и Ф.3 ПРИНЯТЫ, вердикты |
| [284](284-str-slice-one-door.md) | План 284: срез строки — одна дверь, s[a..b] идёт через str @index | В РАБОТЕ — ЖДЁТ ТОЛЬКО Ф.5 (три прогона интегратора) И ПЕРЕМЕРА Ф.2(в) ПОСЛЕ ЧУЖОГО ФИКСА. **Ф.0** замерена. **Ф.1, Ф.2а, Ф.3, Ф.4** СДЕЛАНЫ и доказаны прогоном (2026-09-07/08); спека D470 написана в… |
| [285](285-float-format-own.md) | План 285 — число в строку без libc: свой кратчайший round-trip | В РАБОТЕ — Ф.0 и Ф.1 ПРИНЯТЫ КОМПИЛЯТОРОМ (2026-09-09 и 2026-09-10 00:30): |
| [286](286-db-driver.md) | План 286 — драйвер БД: граница, значения, ресурсы, первый носитель | ⬛ ЧЕРНОВИК, **ФИНАЛИЗИРОВАН 2026-09-12** (номер назначен интегратором |
| [287](287-array-literals-and-static-lowering.md) | План 287 — литералы массивов: повторение, статика, вывод длины | ⬛ ЧЕРНОВИК (номер назначен интегратором 2026-09-15; к исполнению не принят) |
| [288](288-extern-c-no-bare-pointer.md) | План 288 — голый указатель в extern "C" под запрет: конвенция, страж, линт | ⬛ ЧЕРНОВИК (номер назначен интегратором 2026-09-15; к исполнению не принят) |
| [289](289-regex-own-engine.md) | План 289 — регулярные выражения: свой движок RE2-семьи, довести std/text/regex.nv | ОТКРЫТ 2026-09-15, ни одна фаза не начата. Решение владельца 2026-09-15 по |
