...
> **Автосгенерировано**: `bash scripts/tools/gen-plan-status.sh`, дата генерации: 2026-08-02 08:43 UTC.
...
| [241](241-site-docs-footer.md) | План 241 — сайт: подвал контент-страниц (Edit/Source, Open an issue, дата источника) | 🆕 PLANNED (записан 2026-08-02 по слову владельца; идея — по образцу opencode.ai/docs). |
