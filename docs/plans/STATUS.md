...
> **Автосгенерировано**: `bash scripts/gen-plan-status.sh`, дата генерации: 2026-07-27 08:43 UTC.
...
| [222.3](222.3-extractors.md) | План 222.3 — модуль polaris.extract: типизированное извлечение из запроса | 📋 ДИЗАЙН, НЕ СОГЛАСОВАН. **Слой:** 2 (Polaris-ядро). |
...
| [222.5](222.5-respond.md) | План 222.5 — модуль polaris.respond: IntoResponse + типизированный статус | 📋 ДИЗАЙН, НЕ СОГЛАСОВАН. **Слой:** 2 (Polaris-ядро). |
| [222.8](222.8-openapi-gen.md) | План 222.8 — OpenAPI-генерация через #impl(Reflect) (только (а); (б)-верификация отложена) | ✅ СОГЛАСОВАН (владелец 2026-07-27: «ок, согласовано»). Ф.1 🔨 В РАБОТЕ (worktree |
| [222.11](222.11-multipart.md) | План 222.11 — модуль polaris.multipart: формы и загрузка файлов | 📋 ДИЗАЙН, НЕ СОГЛАСОВАН. **Слой:** 3. **Зависит:** 222.3 (`FromRequest`), |
| [222.12](222.12-http-batteries.md) | План 222.12 — батарейки nova-http: модульная раскладка внутри пакета | 📋 ДИЗАЙН, НЕ СОГЛАСОВАН (декомпозиция по запросу владельца 2026-07-23; вынесено из |
| [222.13](222.13-auth.md) | План 222.13 — модуль polaris.auth: JWT/Basic/Bearer + сессии | 📋 ДИЗАЙН, НЕ СОГЛАСОВАН. **Слой:** 3. **Зависит:** 222.3 (`FromRequest`), |
| [222.14](222.14-websocket.md) | План 222.14 — WebSocket: http.ws (слой 1) + upgrade-extractor (слой 2) | 📋 ДИЗАЙН, НЕ СОГЛАСОВАН. **Слои:** 1 (фрейминг/upgrade) + 2 (API-форма). |
...
| [222.21](222.21-router-api-surface.md) | План 222.21 — поверхность Router/Middleware: кросс-фреймворк-разбор + именование | 📋 Ф.0 ИСПОЛНЕНА 2026-07-27 (оркестратор, opus) — см. [docs/research/http-frameworks-gap.md §6](../research/http-frameworks-gap.md#6-ф0-22221--routermiddleware-поверхность-именование--композит-форма--фичи-разведка). |
