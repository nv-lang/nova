...
> **Автосгенерировано**: `bash scripts/tools/gen-plan-status.sh`, дата генерации: 2026-08-29 19:27 UTC.
...
| [266](266-cancellation-outcome.md) | План 266 — исход отмены выражен значением области (D455) | — (нет Статус-строки) |
...
| [278](278-defect-hunter-agent.md) | План 278. Агент-охотник за дефектами | 📋 ЗАВЕДЁН 2026-08-29 интегратором по предложению |
