...
| [240](240-bigrat.md) | План 240 — bigrat (пакет nova-bigint): точные рациональные числа поверх BigInt | ✅ ЗАКРЫТ 2026-08-02 — Ф.1–Ф.6 влиты в nova-bigint main (e5ef51f): gcd, ядро BigRat, арифметика, строки/мосты, тесты+эталоны (slow-lane), README; приёмка интегратора: test 9/0 SKIP4, check 13/0/38 --strict-effects, lint 0 (9 находок поч… |
