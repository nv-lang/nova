...
**Статус:** 📋 УТВЕРЖДЁН ВЛАДЕЛЬЦЕМ 2026-07-22 («Мне нравится! Я согласен» — обсуждение
ревизии src/-канона). Реализация НЕ начата. **Приоритет:** P2, объём малый.
**Очередь (предложение):** ДО тегов v0.1 — `module src.main` виден прямо в витрине-флагмане;
