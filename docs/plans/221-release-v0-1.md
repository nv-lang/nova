...
- **Чистая установка (A-V7-семья): окно №268+№269 ОДНИМ заходом** — общий модуль
  ...
  единственный недостающий кусок чистого клона, проверено фактом). Старт — сразу
  после влития p-152 (одна зона); главный гейт приёмки — чистый клон по шагам
  /install/ до «Hello, Nova!». Разблокирует честную install-страницу сайта.
