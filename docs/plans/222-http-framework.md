...
body-cap по оговорке 222.6). **Паника-в-фибре/recover (222.12 §4): запущено глубокое исследование
(opus, read-only) по запросу владельца 2026-07-23** — как отсутствие recover встретят пользователи;
поведение Go/axum/Express/FastAPI/chi; технические варианты в нашей M:N/C-codegen реальности.
