...
**Ф.0-архитектура исполнена 2026-07-27** (оркестратор, opus) — см. [222.8](222.8-openapi-gen.md):
универсальный `#reflect`-атрибут (call-site metadata collection, НЕ http-специфичный) + вся
HTTP-семантика сборки OpenAPI живёт в nova-polaris. **ТРЕБУЕТ D-амендмента** до Ф.1 (языковое
расширение) — атрибут-имя/D-номер на согласовании владельца (222.8 §8).
