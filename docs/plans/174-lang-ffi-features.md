...
| **174.6** | [C-FFI ABI types](174.6-ffi-abi-types.md) | C-ABI тип-лист (рекурсивный) + `E_FFI_NON_C_ABI_TYPE` + fn-ptr ABI-тег `*extern "C" fn`. Amend D282-FFI (+ D353 для ABI-тега). Spec-часть — сейчас; checker — фазой M1. Поглощает `[M-172.1-extern-cname-dedup-overloads]`. | 🚧 M0 (spec: D282 rule 2 amend + D353 + D216 cross-amend) ✅ DONE 2026-07-04; M1–M3 checker/тег/тесты — follow-up |
