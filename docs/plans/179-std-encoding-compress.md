...
> **Top-level** под-план. Создан 2026-06-26. Статус **🟢 Ф.1 LANDED (2026-07-04)** — inflate/gzip/zlib decode (pure-Nova) готов; brotli (Ф.2) и encode (Ф.3) — «позже». (Ред. 2 — 2026-07-03: аудит ground-truth/7-языков/siblings; stale-номера сняты, D-карта актуализирована, flush/level/FFI-фиксы.) Маркер **[M-179-std-compress]**.
>
