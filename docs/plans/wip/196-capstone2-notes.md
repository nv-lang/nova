...
**[ПОСТСКРИПТУМ ИНТЕГРАТОРА: снос B10h/B10l отменён тем же днём — d45-регрессия маскировала трафик
фикстуры (см. 196-capstone-notes.md §постскриптум); реестр обратно 46 → 48; урок: перепись валидна
только на целиком компилирующемся корпусе.]**
