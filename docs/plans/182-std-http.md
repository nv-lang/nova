...
- **Q9 closure** — RESOLVED §3.0/Q1: HTTP-логика core .nv; byte-транспорт C-routed; compress (Plan 183): inflate/gzip/zlib pure-Nova + brotli C-FFI.
