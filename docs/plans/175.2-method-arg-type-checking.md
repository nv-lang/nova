...
# Plan 175.2 — Method-argument type-checking + scalar-narrowing enforcement

**Статус:** 📋 proposed 2026-06-19
**Umbrella:** [Plan 175 — Переработка компилятора: типовая система](175-compiler-rework.md).
**D-блок:** предв. **D311** (финал при impl; D310=175.3, D309=171, D308=169.2.1)
**Ветка:** TBD (`plan-175.2-method-arg-typecheck`)
**Приоритет:** P1 (soundness).
**Часть:** [Plan 175.1 — Unified type engine](175.1-unified-type-engine.md) — этот план первый
конкретный шаг 175.1 (часть U.1-U.3 на узком кейсе method-arg narrowing).
...
## 9. Целевая архитектура и этапы — см. Plan 175.1

Целевая архитектура (единый типизированный IR) и пошаговая дорожная карта U.1-U.7 живут в
[Plan 175.1 — Unified type engine](175.1-unified-type-engine.md) §3-§4. Этот план (175.2) —
**первый конкретный шаг** 175.1 на узком кейсе method-arg narrowing; раздел §8 выше — детальная
карта «как есть», на которую 175.1 ссылается.
