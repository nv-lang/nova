...
> **Статус:** ✅ ЗАКРЫТ (Этапы 1-5 + R8 audit + P41-3/P41-6 — per-thread
> mmap + lazy commit + single Boehm GC root, снят MAX_ROOT_SETS=128;
> D97 spec). Шапка-метка обновлена 2026-05-21 (аудит план-статусов:
> была устаревшая «не начат»).
> Создан 2026-05-12.
>
...
- Compare с Node.js + libuv, ниже Tokio.
