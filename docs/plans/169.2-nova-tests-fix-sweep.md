...
> **Статус:** ⛔ SUPERSEDED — рамка «nova_tests = гейт шиппинга» отменена конвенцией
> [feedback-nova-tests-not-correctness-gate]; преемник — Plan 198 (spec_tests-миграция) / Plan 182
> (test-suite sanation).
...
- Чинить настоящие баги компилятора — записывать в
  [plan-169.2-compiler-fixes.md](../dev/plan-169.2-compiler-fixes.md).
...
### ✅ Багфиксы компилятора ([plan-169.2-compiler-fixes.md](../dev/plan-169.2-compiler-fixes.md) §5–18)
