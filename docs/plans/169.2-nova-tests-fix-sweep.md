...
- **prelude-partial (plan107)** — решено: развязать core от unicode. Вынесено в
  под-план [169.2.1 core-unicode-decouple](169.2.1-core-unicode-decouple.md)
