...
| **Ф.30 Plan 45.A small wins** (in-progress) | 🟡 | 2 пункта — external crate-doc linking (`NOVA_DOC_EXTERN_LINKS` env для cross-crate refs); incremental cache (mtime-based, `--watch` faster) |
