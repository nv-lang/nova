...
**Статус:** ✅ ЗАКРЫТ 2026-07-21 — «один путь форматирования» достигнут (Ш0-Ш4 + Ш2
перенос примитив-тел, V1-упрощение #3 снято целиком; headline-рассинхрон исправлен по
аудиту 172→221). Ниже — история фаз.
