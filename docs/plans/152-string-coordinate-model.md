...
- D-блоки **D249–D255** зарезервированы под этот план (+ AMEND D26/D238/D58). Если
  spec'и ещё на D248 — бери D249+. Решения по Q закрыты в §4 — перенеси их записями
  в `spec/decisions/` и `spec/open-questions.md` (Q-string-indexing переоткрыть и
  закрыть заново).
