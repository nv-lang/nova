...
# План 44.1: M:N Runtime — Этап 0 (executable sub-plan для Plan 44)

> **Статус:** executable sub-plan, Этап 0 реализован 2026-05-13.
>
> **Parent:** [Plan 44 (M:N runtime roadmap)](44-mn-runtime-roadmap.md).
> Plan 44 — architectural map (что/зачем/Q-вопросы). Plan 44.1 —
...
> 7 архитектурных слоёв + 7 open Q + roadmap до v1.0+. Plan 44.1 закрывает
