...
4. Для каждого файла: вердикт по правилам ниже. Полная построчная таблица (3450 строк) —
   **[198-triage-files.tsv](198-triage-files.tsv)** (TSV: file · verdict · status · note).
   Здесь — только agregированная сводка по директориям + особые списки.
