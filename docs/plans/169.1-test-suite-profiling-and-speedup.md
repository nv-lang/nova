...
> **Канонический план — [169.1.4](169.1.4-panics-clause.md)** (извлечён 2026-06-20). Раздел
> ниже — исходный дизайн; актуальная версия (с исправленной формулировкой риска) в 169.1.4.
...
| 169.1.4 | [panics-clause](169.1.4-panics-clause.md) | **`panics`-клаузула** (извлечена из 169.1.2 Ф.2): `test "…" panics "X"` инверсия PASS/FAIL → runtime-panic в folder-module. | −78 CU (📋 отложен, гейт 172) |
...
`[M-169.1.2-consolidate]`, `[M-169.1.4-panics-clause]`.
