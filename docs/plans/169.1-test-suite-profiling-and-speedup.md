...
> **Канонический план — [173](173-panics-clause.md)** (извлечён 2026-06-20 в top-level). Раздел
...
тестами после panic-longjmp. Подробно (исправленная формулировка) → [Plan 173](173-panics-clause.md).
...
| → [173](173-panics-clause.md) | **`panics`-клаузула** (была фазой 169.1.2, поднята в top-level [Plan 173](173-panics-clause.md)): `test "…" panics "X"` инверсия PASS/FAIL → runtime-panic в folder-module. | −78 CU (📋 отложен, гейт 172) |
