...
W1 (летит) → **S1 звучность захватов** (№150 файбер-гонка + №117 share×fn +
№242§3 escaping — порча данных при молчащем check; + №168 handler-coercion,
блокер тега, соседняя зона эффектов) → **W2** (№254, утверждён критическим) →
**S2 каналы** (№143 фиктивная типизация + №144 send-consume P0 — решение
владельца есть) → **W3** (bare-варианты — тихий чужой тип) → **W4** (P67
