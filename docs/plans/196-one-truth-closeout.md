...
Миграция второго окна идёт ДВУМЯ НЕЗАВИСИМЫМИ волнами (каждая — САМОСТОЯТЕЛЬНЫЙ путь закрытия 196; владелец 2026-07-13), каждая — свой под-план:
...
Закрытие 196 = СТРУКТУРНЫЙ ФИНАЛ-ГЕЙТ, достигнутый ЛЮБОЙ волной (или их суммой): `infer_call_ret_c` пуст/удалён, сиблинги через одно окно → второе окно удалено, матрица
