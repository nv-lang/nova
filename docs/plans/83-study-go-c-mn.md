...
**Followups (заведены):**
- `[M-83.11-f1b-acquire-capacity]` — ✅ **RESOLVED 2026-06-11** (commit `98b4b05c6ae`):
  `nova_sched_cap_acq()` ACQUIRE-load на всех ~14 accessor-guard сайтах. Q28 закрыт.
  Verified x86: smoke + grow_vs_wake 40/40.
