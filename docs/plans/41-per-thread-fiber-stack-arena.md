...
roots), P41-12 (pthread cleanup), P41-13 (compile flags из Plan 40
...
- Plan 41 design solid; integration blocker — Boehm/Docker, не arena
  semantics.
...
- Wait for Plan 41 wire-up validation (native Linux required).
- Adopt Plan 41 architecture без switch'а minicoro allocator (run
  Plan 23 scheduler с current calloc; arena = optional bonus для
  scaling).

### Honest disclosure

В audit rounds 1-4 я proclaimed Plan 41 «just need to wire it up».
