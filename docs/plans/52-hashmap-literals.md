...
`std/collections/hashmap.nv` — **чистый Nova**, как и весь
`std/collections/`. Литерал ничего не меняет: HashMap остаётся обычным
Nova-кодом, литерал — синтаксический сахар над его публичным API.
