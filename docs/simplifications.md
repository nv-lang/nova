...
- **Test:** [`nova_tests/plan59/f19_tuple_in_result.nv`](../nova_tests/plan59/f19_tuple_in_result.nv)
  — 5 sub-tests.
- **Out-of-scope (future):** Полный mono'd Result (NovaRes_<T>_<E>
  typedefs per concrete combo analogous к Option) — ≈ Plan 56 vtable
  scope; этот fix покрывает все наблюдаемые use-cases без системного
  refactor'а.
