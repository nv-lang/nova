...
регрессионный набор ловит *известные* классы багов, cross-check —
*неизвестные*.
...
формулу на стороне Z3 (класс багов из Plan 33.8), был бы пойман
...
|---|---|
| `#must_verify_module` — строгий режим для всего модуля | [D113](../../spec/decisions/09-tooling.md#d113) (Plan 33.3, V2) |
