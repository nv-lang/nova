...
| 6 | [`net/`](net/) / [`tls/`](tls/) | Matched echo server/client pairs demonstrating the native-module dependency pattern (Plan 193/195) — plain TCP vs TLS, same shape. Both pairs build clean. |
