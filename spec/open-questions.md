...
>
> Реализация unified `Buffer` (закрыта 2026-05-07) **удалена** в
> Plan 04 Этап 3 — заменена на StringBuilder/WriteBuffer/ReadBuffer.
> История ниже сохранена для понимания эволюции; **не использовать
> в новом коде**.
>
...
> Plan 04 (`docs/plans/04-buffer-split-and-external.md`).
