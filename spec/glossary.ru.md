...
| проверяемое сужение | checked narrowing | "Checked narrowing — `to_*` (D430, 2026-07-20)" | spec/conversions.ru.md heading; полностью по-русски; проверяемая альтернатива тихому `as`-wraparound |
