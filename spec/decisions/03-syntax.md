...
| `\xNN` | байт по двум hex-цифрам, 00..FF |
...
**Список не выдуман, а замерен** на оракуле 2026-08-29 (`lexer/mod.rs`,
разбор строкового литерала): первые девять форм уже реализованы ровно так;
новизна §2 в том, что список стал НОРМОЙ, а не свойством реализации.
...
Пункт 3 — про СИНТАКСИС, и он не спорит с D412: там байты файла
