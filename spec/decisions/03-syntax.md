...
**AMEND (Plan 159 Ф.4 / Plan 169.2.1, D303, 2026-06-19):** char-@методы фактически
...
std.unicode`); Plan 169.2.1 [D303](07-modules.md#d303) вернул их в `category.nv` и
восстановил resolver-инъекцию, чтобы `core` не тянул unicode (фикс частичного
`#prelude(core, …)`). См. [D303](07-modules.md#d303).
