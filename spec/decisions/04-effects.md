...
>
> **⚠️ Уточнение 2026-06-20 ([Plan 174](../../docs/plans/174-question-mark-return-only.md)):**
...
> `.map_err` (причины — в Plan 174, Часть B). NB: устаревшая секция `## D4` выше (и дубль
> `####`) противоречит D85 — чинится в Plan 174.
