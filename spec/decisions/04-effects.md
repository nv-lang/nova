...
>
> **⚠️ Уточнение 2026-06-20 ([Plan 172.7](../../docs/plans/172.7-question-mark-return-only.md)):**
...
> `.map_err` (причины — в Plan 172.7, Часть B). NB: устаревшая секция `## D4` выше (и дубль
> `####`) противоречит D85 — чинится в Plan 172.7.
