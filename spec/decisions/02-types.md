...
[Plan 214](../../docs/plans/214-coerce-attribute.md) R12 (эффект-свобода,
прецедент для §1) · [Plan 216](../../docs/plans/216-consume-enforce-a.md)
(ортогонален — периметр видимости передач владения не меняется, D432
ослабляет только «непередачу», не «передачу»).
