...
- **Поля с умолчанием идут ПОСЛЕ полей без умолчания** — см. [D478](#d478-умолчания-только-в-хвосте-решение-владельца-2026-09-14).
  ...
  рекомендация без запрета. D478 это разрешение ОТМЕНЯЕТ.
...
## D478. Умолчания только в хвосте (решение владельца 2026-09-14)
...
— compile error». D478 распространяет его на поля именованного кортежа, где амендмент
