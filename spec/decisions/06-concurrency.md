...
concurrent-выполнения берутся через `#share`-примитивы/каналы
([D415](#d415-data-race-freedom--share-атрибут-capture-check-consume-в-spawn-plan-1733) — голый mut-захват = `[E_CONCURRENT_MUT_CAPTURE]`), не через
