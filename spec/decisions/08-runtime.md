...
|---|---|---|
| `hash() -> u64` | беззнаковый 64-bit хеш | int, bool, f64, char, byte, str |
| `eq(Self) -> bool` | равенство | int, bool, f64, char, byte, str |
| `lt(Self) -> bool` | строго меньше | int, f64, char, byte, str |
| `le(Self) -> bool` | меньше или равно | int, f64, char, byte, str |
| `gt(Self) -> bool` | строго больше | int, f64, char, byte, str |
| `ge(Self) -> bool` | больше или равно | int, f64, char, byte, str |
...
**hash:**
- `int`/`char`/`byte` — FNV-1a по 8 байтам значения (`nova_int_hash`).
