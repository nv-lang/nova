...
> **НОРМА ПЕРЕЕХАЛА 2026-09-18: [D478](decisions/03-syntax.md#d478).** Этот
> раздел больше НЕ источник правил — он история. Причина переезда названа в
> самом D478 и стоит того, чтобы знать её здесь: грамматика, закрывшая вопрос,
...
> D478 определяет алфавит `raw-char` и ЗАПРЕЩАЕТ сырой управляющий байт
