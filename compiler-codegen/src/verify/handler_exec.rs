...
fn subst_ident_in_expr(
    ...
    crate::ast::Expr { kind: new_kind, span: expr.span, id: crate::ast::ExprId::UNSET, debug_only: false }
}
                    ...
                    for (var, then_val) in &then_asgns {
                        if let Some((_, else_val)) = else_asgns.iter().find(|(v, _)| v == var) {
                            ...
                            let ite_expr = crate::ast::Expr {
                                ...
                                span: e.span, id: crate::ast::ExprId::UNSET, debug_only: false,
                            };
        ...
        let cond = match &arm.pattern {
            crate::ast::Pattern::Literal(lit, _) => {
                ...
                let lit_expr = crate::ast::Expr {
                    kind: lit_expr_kind,
                    span: arm.span, id: crate::ast::ExprId::UNSET, debug_only: false,
                };
                Some(crate::ast::Expr {
    ...
    for var in &vars {
        ...
        for (cond, val) in branches.into_iter().rev() {
            acc = crate::ast::Expr {
                ...
                span: match_span, id: crate::ast::ExprId::UNSET, debug_only: false,
            };
        }
...
fn rewrite_post_in_expr(
    ...
    Ok((crate::ast::Expr { kind: new_kind, span: formula.span, id: crate::ast::ExprId::UNSET, debug_only: false }, changed))
}
