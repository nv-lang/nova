                        ...
                        for pname in param_names {
                            ...
                            if matches.len() == 1 {
                                auto_args.push(crate::ast::Expr {
                                    ...
                                    span: apply_span, id: crate::ast::ExprId::UNSET, debug_only: false,
                                });
                            } else {
                                auto_ok = false;
                                break;
    ...
    for s in &body.stmts {
        ...
        let synthetic_value: Expr = match assign_op {
            ...
            AssignOp::Add => Expr {
                ...
                span: value.span, id: crate::ast::ExprId::UNSET, debug_only: false,
            },
            // x -= k  →  synthetic: x - k
            AssignOp::Sub => Expr {
                kind: ExprKind::Binary {
...
fn stmt_has_assignment(s: &Stmt) -> bool {
    match s {
        ...
        Stmt::Defer { body, .. } => expr_has_assignment(body),
...
fn collect_bv_arith_in_stmt(
    ...
    match s {
        ...
        Stmt::Throw { value, .. } | Stmt::Defer { body: value, .. } => {
