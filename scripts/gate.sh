...
# Числитель трека — метки «НАЙДЕНО ОХОТНИКОМ <дата> (novac|oracle)» в реестре,
...
# форме (урок №801), рукописной сетки в дереве нет, храповик вниз. Трек oracle
# сеткой не судится: оси в доке нет (граница Ф.6, названа в леджере оракула).
