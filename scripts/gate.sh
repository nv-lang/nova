...
step "lsp-tests (собственный набор расширения — №723)"
guard --deadline 300 "$ROOT/scripts/guards/check-lsp-tests.sh" "$ROOT" || fail "тесты nova-lsp красные: расширение входит в поставку, а его набор до 2026-08-18 не гонял ни гейт, ни CI (№723)"
