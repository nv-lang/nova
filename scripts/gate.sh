...
bash "$ROOT/scripts/guards/check-doc-conventions.sh" "$ROOT" || fail "doc-conventions (шапка/frontmatter spec en, guide-парность, статус-строка плана, dev-ссылки, код-блоки пар — см. вывод выше)"
