#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# scripts/guards/check-novac-prim-id-compare.py — семья прима спрашивается у двери,
# не у одного id. План: docs/plans/274.5-read-own-source.md §3-пред59; реестр
# 221.1 №910; аудит — план 274 §10.3а. Самотест: selftest/test-check-novac-prim-id-compare.sh.
...
План: docs/plans/274.5-read-own-source.md §3-пред59 (волна «десять типов»);
реестр 221.1 №910. Аудит стража — план 274 §10.3а.
