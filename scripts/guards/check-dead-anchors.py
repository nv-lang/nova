...
Адрес: реестр 221.1 №1182 (замер 2026-09-20). Ссылка проставлена в этой форме
дословно, потому что `check-guard-wiring` ищет именно её: родительный падеж
(«реестра 221.1») мимо его образца, и страж три часа числился беспризорным.
