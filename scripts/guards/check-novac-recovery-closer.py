...
План: docs/plans/274.3-review-findings-classes.md (находка F15); архитектура — novac-architecture.md
§5а (три правила восстановления); аудит стража — план 274 §10.3а. Самотест:
selftest/test-check-novac-recovery-closer.sh (шесть случаев).
