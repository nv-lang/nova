...
ПОПРАВКА 2026-09-23: к знакам добавлены Э (волна плана, `Э.4`) и Ф (фаза,
`Ф.2-v4`), плюс ведущая точка (`Э.4` — точка ПЕРЕД цифрой, как в орфографии
плана) и суффикс `-v<n>` (номер версии фазы, `Ф.2-v4`). Замер: канонический
текст оракула `E_INCOMPLETE_HANDLER_OP_DECL` несёт `Plan 175.2 Ф.2-v4 П4`
дословно (задание окна nova-6e, 2026-09-22), и три уже закоммиченные строки
с `Э.4` красили стража с волны 274.11 — форма ссылки та же, знаки в паттерне
не были названы.
...
# Необязательный буквенный суффикс ссылки: а-я и ё; знаки — П/№/§ плюс Э и Ф
# (волна и фаза плана, поправка 2026-09-23 в шапке). Ведущая точка и суффикс
# -v<n> — орфография плана: `Э.4`, `Ф.2-v4`.
REF = re.compile(r"(П|№|§ ?|Э|Ф) ?\.?[0-9]+(\.[0-9]+)*(-v[0-9]+)?[а-яё]?")
