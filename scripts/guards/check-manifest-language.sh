...
# принуждение норм) — семья стражей, к которой относится и этот; реестр 221.1
# №542 (код, который ничто не собирает, гниёт) объясняет исключение
# `nova_tests.old`. Норма о языке манифестов — решение владельца 2026-08-10,
# парная стражу языка коммитов (check-commit-language.sh, норма 2026-08-09).
#
# ИСПОЛЬЗОВАНИЕ:
