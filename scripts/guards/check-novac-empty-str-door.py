...
План: docs/plans/274-novac-self-hosted-compiler.md (ярус novac, волна M2b); правило — docs/dev/novac-compiler-conventions.md П37; носители — реестр docs/plans/221.1-bug-sweep.md.
