...
Адрес: план 274, класс К5 — там разобран случай ИМЕННО этого стража:
он приехал от соседнего окна и лежал без внешнего вызывающего. Правило, которое
он держит, живёт в `docs/dev/claude-commands.md`.
