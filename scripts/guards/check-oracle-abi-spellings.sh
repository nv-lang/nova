...
# интегратором).
#
# План: docs/plans/274-novac-self-hosted-compiler.md — трек Carina, чей интероп
# сидит на этих спеллингах; класс «дрейф, видный только чужому треку и
# только позже» — реестр 221.1 №884.
#
